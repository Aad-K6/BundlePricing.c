...
if(b>=1 && b<100000)
{
printf("\n Price of one doodad is :%d ",b);
}
else
{
printf("\n Please enter price between range 1 to 100000 only ");
}
printf("\n Enter which digit you want to trail between 0 to 9: ") ;
scanf("%d",&d);
if(d>=0 && d<=9)
{
printf("\n Trailing digit you wish to trail is %d: ",d);
}
else


{
printf("\n Please enter the trailing digit between 0 to 9 only ");
}
...
printf("\n No. of digit trailed is:%d times",c);
return 0;
}
